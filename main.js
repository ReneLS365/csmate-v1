...
function setupListSelectors() {
  ...
  container.innerHTML = `
    <label><input type="checkbox" id="chkBosta" checked> Bosta</label>
    <label><input type="checkbox" id="chkHaki" checked> Haki</label>
    <label><input type="checkbox" id="chkModex" checked> Modex</label>
  `;
